"""Tests for msgraphclient.settings."""

from msgraphclient.settings import GRAPH_DEFAULTS, GraphSettings, parse_popup_size
...
def test_parse_popup_size_uses_default_on_invalid_input() -> None:
    ...
    assert GRAPH_DEFAULTS.auth_popup_size == "520x680"
